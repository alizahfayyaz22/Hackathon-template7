  ...
  return (
    <div className="flex overflow-hidden flex-col p-6 bg-white rounded-xl min-w-[240px] w-full sm:w-[304px] max-w-sm mx-auto relative border border-gray-50">
      ...
      <Image 
        ...
        width={204} 
        height={128} 
        className="object-contain self-center mt-8 max-w-full aspect-[3.18]" 
      />

      <div className="flex gap-4 items-start mt-8 text-sm font-medium leading-5 text-slate-400 sm:mt-10">
...
const PopularCarPage: React.FC = () => {
  const cars = [
    {
      name: "MG ZX Exclusice",
      type: "Hatchback",
      image: "/Images/image 15.png", // Dynamic car image with correct path
      fuelCapacity: "90L",
      transmission: "Manual",
      capacity: "6 People",
      price: 72,
    ...
    },
    {
      name: "New MG ZS",
      type: "SUV",
      image: "/Images/image 16.png", // Dynamic car image with correct path
      fuelCapacity: "60L",
      transmission: "Manual",
      capacity: "6 People",
      price: 80,
    ...
    },
    {
      name: "New MG ZS",
      type: "SUV",
      image: "/Images/image 18.png", // Dynamic car image with correct path
      fuelCapacity: "55L",
      transmission: "Manual",
      capacity: "6 People",
      price: 80,
  ...
  return (
    <div className="p-6 bg-gray-100">
      ...
      <div className="flex justify-center mt-8">
        <button
          className="px-6 py-3 text-base font-medium text-white bg-[#3563E9] rounded"
